...
import {
  useApplicantAddress,
  useEditAppAddress,
} from "../../hooks/useApplicantAddress";
...
export type EditAppAddressFormData = z.infer<typeof schema>;

const ApplicantAddressEditPage = () => {
  ...
  const { data: address } = useApplicantAddress(getUserId()!);
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useForm<EditAppAddressFormData>({
    resolver: zodResolver(schema),
  });
  const update = useEditAppAddress(() =>
...
export default ApplicantAddressEditPage;
