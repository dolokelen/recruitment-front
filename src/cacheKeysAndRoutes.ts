...
export const CACHE_KEY_APPLICANT = "applicant";
...
export const APPLICATION_FORM_ROUTE = "application-form";
export const APPLICATION_PROFILE_ROUTE = "application-profile";
